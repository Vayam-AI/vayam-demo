  ...
  return (
    <div className="flex items-center justify-center gap-8 pt-4 voting-buttons">
      ...
      >
        ...
        <span className="text-xs font-semibold mt-1">{voteCounts.dislikes || 0}</span>
      </motion.button>
      ...
      >
        ...
        <span className="text-xs font-semibold mt-1">{voteCounts.neutral || 0}</span>
      </motion.button>
      ...
      >
        ...
        <span className="text-xs font-semibold mt-1">{voteCounts.likes || 0}</span>
      </motion.button>
    </div>
  );
}; 